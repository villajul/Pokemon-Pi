...
export const GetPokemonDetail = (id) => async(dispatch)=>{
    try {
        const payload = await axios.get(`http://localhost:3001/pokemons/${id}`).then(res => res.data)   
...
export const GetPokemon = (name) => async (dispatch) => {
    try {
        const payload = await axios.get(`http://localhost:3001/pokemons?name=${name}`).then(res => res.data)                     
...
export const FilterByAttack = (payload) => {
 ...
 export const GetType = () => async (dispatch)=>{
    try {
        const payload = await axios.get('http://localhost:3001/types').then(res => res.data)                     
